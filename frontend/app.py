# -*- coding: utf-8 -*-
"""
frontend/app.py — "หลังบ้าน" (backend) ของเว็บ CS2 Analytics
...
รัน:  python -m uvicorn frontend.app:app --reload
...
load_dotenv(ROOT / ".env")        # เรียกใช้ฟังก์ชันข้างบนทันที — .env ไฟล์เดียวที่รากโปรเจกต์
                                  # ใช้ร่วมกับ docker compose ไม่ต้องมีสองที่ให้สับสน
...
def page_login():
    """หน้าล็อกอิน"""
    return FileResponse(PAGES_DIR / "login.html")   # ส่งไฟล์ login.html กลับไปให้เบราว์เซอร์วาด
