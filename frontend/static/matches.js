// ==========================================================================
// matches.js — สมองของหน้า "แมตช์"  (คู่กับ frontend/pages/matches.html)
//
// ซ้าย = ตารางแมตช์ทั้งหมด · คลิกแถวไหน ขวาจะโชว์รายละเอียดของแมตช์นั้น
// ==========================================================================
...
async function openMatch(id) {
  ...
  box.innerHTML = '<div class="empty">กำลังโหลด…</div>';       // โชว์ระหว่างรอ จะได้ไม่เงียบ
  ...
  // title="..." = ข้อความที่โผล่ตอนเอาเมาส์ค้างบนกล่อง
