...
if pos_path.exists():
    ...
    print("!! ไม่มี positions_1hz.parquet — ข้าม buy type (รัน backend/parser/positions.py ก่อน)")
...
if gren_path.exists():
    ...
    print("!! ไม่มี grenades.parquet — ข้าม utility (รัน research/parse_grenades.py ก่อน)")
