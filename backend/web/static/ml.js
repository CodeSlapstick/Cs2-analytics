...
function drawRoundWin() {
  ...
  // คีย์หน้าตาแบบ "3v2|0|20-40s" — ต้องประกอบให้ตรงกับที่ research/round_win.py เขียนไว้เป๊ะ ๆ
...
async function loadGrid() {
  ...
  drawKpis("gridKpis", [
    ...
    { k: "แมพ",          v: esc(g.map),                                s: "ตั้งค่าที่ research/grid_ml.py" },
  ]);
...
// ทีมรันได้จาก CLI (python research/round_win.py --source=db) หรือ POST /api/ml/retrain ผ่าน /docs
